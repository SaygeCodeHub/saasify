...
LoadApplyLeaveScreenModel loadApplyLeaveScreenModelFromJson(String str) =>
    LoadApplyLeaveScreenModel.fromJson(json.decode(str));

String loadApplyLeaveScreenModelToJson(LoadApplyLeaveScreenModel data) =>
...
class LoadApplyLeaveScreenModel {
  ...
  factory LoadApplyLeaveScreenModel.fromJson(Map<String, dynamic> json) =>
      LoadApplyLeaveScreenModel(
        status: json["status"],
