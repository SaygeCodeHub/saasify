...
import 'package:saasify/screens/viewData/pos_grid_view.dart';
...
class ViewDataWeb extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return (viewData.columns == null && viewPosData.isEmpty)
        ? Row(
            children: [
        ...
        : (isOnline)
            ...
            : PosGridView(
                posDataMap: {'isMobile': isMobile}, viewPosData: viewPosData);
  }
